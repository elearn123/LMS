...
public class CalTRExtension extends TR
{
    ...
    public TR addHeading(final String strtime, final String strMycalendar) {
        final TR tr = new TR().addElement((Element)new TD().addElement((Element)new IMG().setBorder(0).setHeight(8).setWidth(3).setSrc("../coreadmin/images/T.gif"))).addElement((Element)new TD().addElement(strtime)).addElement((Element)new TD().addElement((Element)new IMG().setBorder(0).setHeight(8).setWidth(7).setSrc("../coreadmin/images/T.gif"))).addElement((Element)new TD().addElement(strMycalendar));
        return tr;
    }
    ...
    public TR addWeekviewdays(final Vector vWeekdata, final int size) {
        final String str1122 = "";
        ...
        for (int i = 0; i < vWeekdata.size(); ++i) {
            final String[] strWeek = (String[]) vWeekdata.elementAt(i);
            if (i == 0) {
                tr.addElement((Element)new TD().setAlign("left").setHeight(5).setNoWrap(true).addElement((Element)new NOBR().addElement((Element)new A().setHref("javascript:calendarMethod('" + weekview + "','" + strWeek[1] + "');").addElement((Element)new Font().setFace("verdana").setSize(size).setColor("#008000").addElement(strWeek[0] + "&nbsp;")))));
            }
            else if (CalDataBaseLayer.getCalendardate(strWeek[1])) {
                tr.addElement((Element)new TD().setBgColor("#999999").setAlign("left").setHeight(5).setNoWrap(true).addElement((Element)new NOBR().addElement((Element)new A().setHref("javascript:calendarMethod('" + dayview + "','" + strWeek[1] + "');").addElement((Element)new Font().setFace("verdana").setSize(size).setColor("#0000FF").addElement(strWeek[0])))));
            }
            else {
                tr.addElement((Element)new TD().setAlign("left").setHeight(5).setNoWrap(true).addElement((Element)new NOBR().addElement((Element)new A().setHref("javascript:calendarMethod('" + dayview + "','" + strWeek[1] + "');").addElement((Element)new Font().setFace("verdana").setSize(size).setColor("#0000FF").addElement(strWeek[0])))));
            }
        }
        return tr;
    }
    
    public TR addWeekviewdate(final Vector vWeekdata) {
        final String dayview = "dayview";
    ...
    public TR addRowUserForReminder(final String r_id, final String r_name, final String reminder, final String bname, final Option[] option, final String before, final String aname, final Option[] option1, final String after) {
        final Input inputCheck1 = new Input();
        inputCheck1.setOnClick("CCA()");
        final TR tr = new TR().addElement((Element)new TD().setWidth("8%").setNoWrap(true).setHeight(15).addElement((Element)inputCheck1.setType("radio").setName(r_id).setValue(r_name).setTabindex("1"))).addElement((Element)new TD().setWidth("80%").setNoWrap(true).setHeight(15).addElement((Element)new NOBR().addElement((Element)new Font().setColor("003366").setFace("verdana").addElement(reminder).setSize(-2).addElement(" ").addElement((Element)new Select().setName(bname).addElement(option)).addElement(" ").addElement(before).addElement(" ").addElement((Element)new Select().setName(aname).addElement(option1)).addElement(" ").addElement(after))));
        return tr;
    }
