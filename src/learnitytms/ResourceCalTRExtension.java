...
public class ResourceCalTRExtension extends TR
{
    ...
    public TR addWeekviewdays(final Vector<String[]> vWeekdata, final int size, final String[] vres) {
        ...
        for (int i = 1; i < vWeekdata.size(); ++i) {
            ...
            if (i == 0) {
                ...
                final Vector strresourceid = DataBaseLayer.getCalendardateRes(strWeek[1], vres);
