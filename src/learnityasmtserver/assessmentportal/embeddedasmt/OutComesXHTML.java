...
public class OutComesXHTML extends HttpServlet
{
    ...
    public void doGet(final HttpServletRequest request, final HttpServletResponse response) throws IOException, ServletException {
        ...
        System.out.println("course_id==outcomesxhtml====" + course_id);
        ...
        final Hashtable hashIdentifier = (Hashtable)mysession.getAttribute("SESSION_COURSE_ITEM");
        final String identifier2 = (String) hashIdentifier.get(course_id);
        System.out.println("identifier1==outcomesxhtml===1=" + identifier2);
        ...
        final String strCompliationMsg = (String) hAsmttTable.get("result_message");
        ...
        if (this.resultViewToUser) {
            ...
            if (asmtcutValue <= asmtScore) {
                ...
                System.out.println("identifier==outcomesxhtml====" + identifier);
                System.out.println("ls==outcomesxhtml====" + ls);
        ...
        final String total_mark2 = (String) hAsmttTable.get("total_marks");
    ...
    public tr SliderType(final Vector response, final Vector question, final String str, final int no, final Hashtable hSectionExtention) {
        ...
        OutComesXHTML.log.debug("srtNegscore=======" + srtNegscore);
        String strCorrectFeedback = "";
        String strIncorrectFeedback = "";
        this.totalScore += iScore;
        if (vFeedback != null) {
    ...
    public tr MultipleResponseHTML(final Vector response, final Vector question, final String[] str1, final int no, final Hashtable hSectionExtention) {
        ...
        final String strItem_id = (String) (String) hSectionExtention.get("item_id");
        final String stritem_name = (String) hSectionExtention.get("item_name");
        final String stritem_type = (String) hSectionExtention.get("item_type");
        final String stritem_answer = (String) hSectionExtention.get("item_answer");
        final String item_obmarks = (String) hSectionExtention.get("item_obmarks");
    ...
    static {
        log = new SimpleLogger((Class)OutComesXHTML.class, true);
    }
}
