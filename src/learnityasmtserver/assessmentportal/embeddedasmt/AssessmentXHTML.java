...
public class AssessmentXHTML extends HttpServlet
{
    ...
    public void doGet(final HttpServletRequest request, final HttpServletResponse response) throws IOException, ServletException {
        ...
        System.out.println("sco_id==sco_id=" + sco_id);
    ...
    public XMLDocument HTMLParser(final String argv) {
        ...
        try {
            ...
            AssessmentXHTML.log.fatal("Show warrings : " + e.toString());
            AssessmentXHTML.log.dbe(DebugLevel.L1_FATAL, (Throwable)e);
        }
        return doc;
    }
    ...
    public URL createURL(final String fileName) {
        ...
        try {
            ...
            try {
                ...
                AssessmentXHTML.log.fatal("Cannot create url for: " + fileName);
                System.exit(0);
            }
        }
        return url;
    ...
    static {
        log = new SimpleLogger((Class)AssessmentXHTML.class, true);
    }
}
