...
public class GenerateTestXHTML extends HttpServlet
{
    ...
    public void doGet(final HttpServletRequest request, final HttpServletResponse response) throws IOException, ServletException {
        ...
        GenerateTestXHTML.log.debug("student_id=doget=" + student_id);
        if (student_id != null) {
    ...
    public void getResult(final HttpServletRequest request, final HttpServletResponse response, final PrintWriter out, final String student_id) throws IOException, ServletException {
        ...
        GenerateTestXHTML.log.debug("questionAll====" + questionAll);
        ...
        GenerateTestXHTML.log.debug("vQAns====" + vQAns);
                ...
                switch (iTitle) {
                    ...
                    case 4: {
                        ...
                        for (int i2 = 0; i2 < leftoption.size(); ++i2) {
                            ...
                            GenerateTestXHTML.log.debug("===str11=========" + str11);
                            final String str8 = request.getParameter(type2);
                            GenerateTestXHTML.log.debug("===str21=========" + str8);
                            l2[i2] = str7;
                            r1[i2] = str8;
                        }
        ...
        GenerateTestXHTML.log.debug("vQuesIdAns==" + vQuesIdAns);
        if (newtest == null || !newtest.equals("start")) {
            if (preview_param == null) {
        ...
        try {
            ...
            GenerateTestXHTML.log.debug("INPUT LOCALE NAME IS " + Locale.getDefault());
            final double amt = 123456.78;
            GenerateTestXHTML.log.debug("LANGUAGE" + dd.getLanguage());
            ...
            e.printStackTrace();
            GenerateTestXHTML.log.debug("Exception:==" + e);
        }
        ...
        if (newtest != null && newtest.equals("start")) {
            ...
            final StAloneTestXHtmlStructure s = new StAloneTestXHtmlStructure();
            ...
            final StAloneTestXHtmlStructure s2 = new StAloneTestXHtmlStructure();
    ...
    private String createElement(final Vector questionAll, final Vector vQuesIdAns) {
        ...
        try {
            ...
            for (int i = 0; i < questionAll.size(); ++i) {
                ...
                switch (strQuestype) {
                    default: {
                        GenerateTestXHTML.log.debug("strQuestype=default=" + strQuestype);
                    }
                    case 0: {
                        titleType = "Multiple Choice";
                        GenerateTestXHTML.log.debug("titleType====" + titleType);
                        break;
                    }
                    case 1: {
                ...
                GenerateTestXHTML.log.debug("ansdata====" + ansdata);
                if (ansdata != null && strQuesId.equals(id)) {
                    ...
                    if (strQuestype == 1) {
                        while (ansdata.length() > 1) {
                            GenerateTestXHTML.log.debug("ansdata.length()====" + ansdata.length());
                            final String check = ansdata.substring(0, ansdata.indexOf(44));
                            GenerateTestXHTML.log.debug("check====" + check);
            ...
            GenerateTestXHTML.log.fatal("Exception:");
            GenerateTestXHTML.log.dbe(DebugLevel.L1_FATAL, (Throwable)e);
        }
        return str1;
    }
    ...
    public Vector getQuestionAnswerVector(final String student_id, final String asmt_id, final String test_id) {
        ...
        try {
            ...
            for (int countNode = itemstatelist.getLength(), i = 0; i < countNode; ++i) {
                ...
                if (attribute2.equals("Multiple Response")) {
                    ...
                    for (int i2 = 0; i2 < countNode2; ++i2) {
                        ...
                        GenerateTestXHTML.log.debug("attribute3[i1]====" + attribute4[i2]);
                    }
                ...
                if (attribute2.equals("Matching Question")) {
                    ...
                    for (int i3 = 0; i3 < countNode2; ++i3) {
                        ...
                        GenerateTestXHTML.log.debug("l1[i1]==ssss==" + l1[i3]);
                        r1[i3] = value.substring(value.indexOf(45) + 1);
                        GenerateTestXHTML.log.debug("r1[i1]==ssss==" + r1[i3]);
                    }
                    v22.addElement(l1);
                    v22.addElement(r1);
    ...
    static {
        log = new SimpleLogger((Class)GenerateTestXHTML.class, true);
    }
}
