...
public class SCCommand
{
    ...
    public static final short RAISEHAND = 28;
    public static final short GIVECONTROLTOUSER = 29;
    public static final short RELEASECONTROL = 30;
    public static final short LOWERHAND = 31;
    public static final short SPEEDUP = 32;
    public static final short TAKECONTROL = 33;
    public static final short SOUND = 34;
    public static final short PRESENTATION = 35;
    public static final short STEPIN = 36;
    public static final short STEPOUT = 37;
    public static final short STARTRECORDING = 38;
    public static final short STOPRECORDING = 39;
    public static final short REFRESH = 40;
