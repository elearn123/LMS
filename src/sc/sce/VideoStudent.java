...
public class VideoStudent extends HttpServlet
{
    public void doGet(final HttpServletRequest request, final HttpServletResponse response) throws IOException, ServletException {
        ...
        System.out.println("==========================student mode========" + mode);
        ...
        if (browser.equals("ie4up")) {
            out.println("<div id=studentvideo>");
            out.println("<div id=studentvideotitle>");
            out.println("LearnITy Return Video");
            out.println("</div>");
            out.println("<div id=studentvideobody>");
            if (mode.equals("D")) {
            ...
            out.println("</div>");
            out.println("<div id=studentplaystopfull>");
            ...
            out.println("<div id=studentvideobody>");
            if (mode.equals("D")) {
                out.println("<embed type=\"application/x-vlc-plugin\"  name=\"video\"  autoplay=\"no\" loop=\"no\" target=\"udp:@" + clientDirectIp + ":" + outputport + "\" HEIGHT=\"250\" WIDTH=\"370\" />");
            }
            else if (reflectorip.equals("")) {
                ...
                out.println("<embed type=\"application/x-vlc-plugin\"  name=\"video\"  autoplay=\"no\" loop=\"no\" target=\"rtsp:@" + clientIp + ":" + outputport + "/" + outputfile + "\" HEIGHT=\"250\" WIDTH=\"370\" />");
            }
            else {
                out.println("<embed type=\"application/x-vlc-plugin\"  name=\"video\"  autoplay=\"no\" loop=\"no\" target=\"http:@" + clientIp + ":" + outputport + "\" HEIGHT=\"250\" WIDTH=\"370\" />");
            }
            out.println("</div>");
            out.println("</div>");
        }
