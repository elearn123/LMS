...
public class TRExtension extends TR
{
    ...
    public TR addRowImage() {
        final TR tr = new TR().addElement((Element)new TD().addElement((Element)new IMG().setBorder(0).setHeight(5).setWidth(160).setSrc("../images/T.gif"))).addElement((Element)new TD().addElement((Element)new IMG().setBorder(0).setHeight(5).setWidth(1).setSrc("../images/T.gif")));
        return tr;
    }
    ...
    public TR addRadio4(final String gender, final String type, final String name) {
        final TR tr = new TR().addElement((Element)new TD().setClassId("PPRLabelText").setWidth("160").addElement(gender)).addElement((Element)new TD().setWidth("336").setClassId("PPCheckRadio").addElement((Element)new Input(type, name, "s").setTabindex("1").setChecked(true).addElement("Single")).addElement((Element)new Input(type, name, "m").setTabindex("1").setChecked(false).addElement("Multiple")));
        return tr;
    }
