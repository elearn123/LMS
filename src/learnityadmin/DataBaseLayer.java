...
/**
 * Title: LearnITy Description: Copyright: Copyright (c) 2003 Company: Aunwesha
 * Knowledge Technologies Pvt. Ltd.
 * 
...
public class DataBaseLayer {
	...
	public static boolean CheckValidUserRow(String stuUsrId, String password, String studentFname, String studentSname,
		...
		if ((stuUsrId.equals("")) && (password.equals("")) && (studentFname.equals("")) && (studentSname.equals(""))
	...
	public static synchronized void insertStudentDetailsfrmExcelSheet(String studentId, String password,
			String studentFname, String studentMname, String studentSname, String accountStatus, String created_by,
			String age, String experience, String education, String gender, String email, String department,
		...
		try {
			...
			oStmt.execute(
					"insert into student_creation_details (student_id,student_created_by,date_student_created,last_modification_date) values('"
							+ studentId + "','" + created_by + "',sysdate(),sysdate())");
	...
	public static synchronized void updateStudentDetailsfrmExcelSheet(String studentId, String password,
			String studentFname, String studentMname, String studentSname, String accountStatus, String age,
			String experience, String education, String gender, String email, String department,
			String selfregistration) {
		...
		try {
			...
			System.out.println(
					"update student_details set sname=?, first_name=?, middle_name=?,account_status=?,age=?  where student_id=?");

			oStmt.execute("update student_creation_details set last_modification_date=sysdate() where student_id='"
					+ studentId + "'");
			oStmt.execute(
					"update student_password set password='" + password + "' where student_id='" + studentId + "'");
	...
	public static synchronized void insertTempStudentDetailsfrmExcelSheet(String stuUsrId, String password,
			String studentFname, String studentMname, String studentSname, String accountStatus, String age,
			String experience, String education, String gender, String email, String department,
			String selfregistration) {
	...
	public synchronized static String getAdminstratorPreviledge(String id) {
		...
		try {
			...
			oRset = oStmt.executeQuery(
					"select count(*) from administrator_previlege_management where user_id=\'" + id + "\'");
			int l_i = 0;
			while (oRset.next()) {
				l_i = oRset.getInt(1);
			}
			...
			oStmt = oConn.createStatement();
			oRset = oStmt.executeQuery(
					"select previledge from administrator_previlege_management " + "where user_id = '" + id + "'");
	...
	public static boolean insertCourse(String table, String course_id, String content, String name, String strSize,
			String user_id, String strdate) {
	...
	public synchronized static void inserttemp_mcontentobj_resource(String resource_id, String element_type,
			String element_value, String content_type, String adl_type, String file_last_uploaded, String sizefile) {
		Statement oStmt = null;
		Connection oConn = null;
		...
		try {
			...
			oConn.setAutoCommit(false);
			oStmt = oConn.createStatement();
			// System.out.println("insert into temp_mcontentobj_resource
			// (resource_id,element_type,element_value,content_type,adl_type,file_last_uploaded,sizefile)
			// values('"+resource_id+"','"+element_type+"','"+element_value+"','"+content_type+"','"+adl_type+"','"+file_last_uploaded+"','"+sizefile+"')");
			oStmt.execute(
					"insert into temp_mcontentobj_resource (resource_id,element_type,element_value,content_type,adl_type,file_last_uploaded,sizefile) values('"
							+ resource_id + "','" + element_type + "','" + element_value + "','" + content_type + "','"
							+ adl_type + "','" + file_last_uploaded + "','" + sizefile + "')");
			...
			System.out.println(
					"......................................BATCH USER UPLOAD................." + e.getMessage());
		} catch (Exception ex) {
	 ...
	 * inserttemp_mcontentobj_organization(String item,String item_title,String
	 * content_object,String file_last_uploaded,String sizeof_file) { Statement
	 * oStmt=null; Connection oConn = null; if(file_last_uploaded==null)
	 * file_last_uploaded=""; // file_last_uploaded="0000-00-00";
	 * if(sizeof_file==null) sizeof_file="";
	 * 
	 * try { oConn = ds1.getConnection(); oConn.setAutoCommit(false); oStmt =
	 * oConn.createStatement(); System.out.
	 * println("insert into temp_mcontentobj_organization (item,item_title,content_object,file_last_uploaded,sizeof_file) values('"
	 * +item+"','"+item_title+"','"+content_object+"','"+file_last_uploaded+
	 * "','"+sizeof_file+"')"); oStmt.
	 * execute("insert into temp_mcontentobj_organization (item,item_title,content_object,file_last_uploaded,sizeof_file) values('"
	 * +item+"','"+item_title+"','"+content_object+"','"+file_last_uploaded+
	 * "','"+sizeof_file+"')");
	 * 
	 * oConn.commit(); oConn.setAutoCommit(true);
	 * 
	 * 
	 * } catch (SQLException e) { System.out.
	 * println("......................................BATCH USER UPLOAD................."
	 * +e.getMessage()); } catch (Exception ex) {
	 * 
	 * } finally{ if(oConn!=null) { try { oStmt.close(); oConn.close(); }
	 * catch(SQLException e) { }
	 * 
	 * 
	 * }
	...
	public synchronized static void inserttemp_mcontentobj_organization(String item, String item_title,
			String content_object, String file_last_uploaded, String sizeof_file, int sequence) {
		Statement oStmt = null;
		Connection oConn = null;
		if (file_last_uploaded == null)
			file_last_uploaded = "";
		...
		try {
			...
			oStmt = oConn.createStatement();
			System.out.println(
					"insert into temp_mcontentobj_organization (item,item_title,content_object,file_last_uploaded,sizeof_file,sequence) values('"
							+ item + "','" + item_title + "','" + content_object + "','" + file_last_uploaded + "','"
							+ sizeof_file + "','" + sequence + "')");
			oStmt.execute(
					"insert into temp_mcontentobj_organization (item,item_title,content_object,file_last_uploaded,sizeof_file,sequence) values('"
							+ item + "','" + item_title + "','" + content_object + "','" + file_last_uploaded + "','"
							+ sizeof_file + "','" + sequence + "')");
	...
	public static void insertContent(String table, String strFile, String unitId, String uploadBy) {
		...
		try {
			...
			rset = stmt.executeQuery(
					"select * from " + table + " where unit_id = '" + unitId + "' and file_name = '" + strFile + "'");
			if (rset.next()) {
				statement.execute(
						"delete from " + table + " where unit_id = '" + unitId + "' and file_name = '" + strFile + "'");
			}

			stmt2.executeUpdate("insert into " + table + " values('" + unitId + "','" + strFile + "',sysdate(),'"
					+ uploadBy + "')");
	...
	public static void deleteContent(String table, String strFilename, String unitId) {
		...
		try {
			oConn = ds1.getConnection();
			stmt = oConn.createStatement();
			rset = stmt.executeQuery("select * from " + table + " where unit_id = '" + unitId + "' and file_name = '"
					+ strFilename + "'");
			if (rset.next()) {
				stmt.execute("delete from " + table + " where unit_id = '" + unitId + "' and file_name = '"
						+ strFilename + "'");
			}
	...
	public static synchronized String checkunitRegistration(String str1) {
		...
		try {
			...
			for (resultset = statement.executeQuery(
					"select a.student_id from unit_student_association a  where a.unit_id='" + str1 + "' "); resultset
							.next();) {
				as = resultset.getString(1);
			}
			if (as == null) {
				for (resultset1 = statement.executeQuery(
						"select a.group_id from unit_group_association a  where a.unit_id='" + str1 + "' "); resultset1
								.next();) {
	...
	public synchronized static void inserttemp_checkunit_consistency(String filename, String resourceid) {
		...
		try {
			...
			oConn.setAutoCommit(false);
			oStmt = oConn.createStatement();
			System.out.println("insert into temp_checkunit_consistency (filename,resource_id) values('" + filename
					+ "','" + resourceid + "')");
			oStmt.execute("insert into temp_checkunit_consistency (filename,resource_id) values('" + filename + "','"
					+ resourceid + "')");
	...
	public static Vector getEntry(String c_id) {
		...
		try {
			...
			statement = oConn.createStatement();
			System.out.println(
					"----getEntry(String c_id)--------select entry_name,cat_description,parent_name,catalog_name,cat_id,entryid,entity_type from catalog_entry_details where cat_id ='"
							+ c_id + "' and parent_name='NULL'");
			oRset = statement.executeQuery(
					"select entry_name,cat_description,parent_name,catalog_name,cat_id,entryid,entity_type from catalog_entry_details where cat_id ='"
							+ c_id + "' and parent_name='NULL'");
			// ResultSet oRset = statement.executeQuery("select
			// entry_name,cat_description,parent_name,catalog_name,cat_id,entryid,entity_type
			// from catalog_entry_details where cat_id ='"+c_id+"' and
			// parent_name='NULL'");
	...
	public static Vector getEntry(String c_id, String p_id) {
		...
		try {
			...
			// entry_name,cat_description,parent_name,catalog_name,cat_id,entryid,entity_type
			// from catalog_entry_details where cat_id ='"+c_id+"' and
			// parent_name='"+p_id+"' and entity_type = 'null'");
			while (oRset.next()) {
	...
	// oStmt = oConn.createStatement();
	// for(ResultSet oRset = oStmt.executeQuery("select
	// cat_id,catalog_name,cat_description from catalog_details where
	// cat_id='"+cat_id+"'");oRset.next();)
	// {
	...
	public static Vector getEntry2(String entry_id) {
		...
		try {
			oConn = ds1.getConnection();
			statement = oConn.createStatement();
			// System.out.println("select topic_id,topic_name,
			// description,course_id from syllabus_details where course_id
			// ='"+c_id+"' and parent_id='"+p_id+"'");
			System.out.println(
					"----------------select entry_name,cat_description,parent_name,catalog_name,cat_id,entryid,entity_type from catalog_entry_details where entryid ='"
							+ entry_id + "' ");
			oRset = statement.executeQuery(
					"select entry_name,cat_description,parent_name,catalog_name,cat_id,entryid,entity_type from catalog_entry_details where entryid ='"
							+ entry_id + "'  ");
			// ResultSet oRset = statement.executeQuery("select
			// entry_name,cat_description,parent_name,catalog_name,cat_id,entryid,entity_type
			// from catalog_entry_details where entryid ='"+entry_id+"' and
			// entity_type = 'null'");
			while (oRset.next()) {
				String str[] = new String[7];
				str[0] = oRset.getString(1);// entry_name
	...
	public synchronized static Vector getCourseDetailsList1() {
		...
		try {
			...
			oStmt = oConn.createStatement();
			oRset = oStmt.executeQuery(
					"select count(*)  from unit_details, unit_creation_details where unit_details.unit_id=unit_creation_details.unit_id");
			int l_i = 0;
			while (oRset.next()) {
				l_i = oRset.getInt(1);
			}
			...
			oStmt = oConn.createStatement();
			oRset = oStmt
					.executeQuery("select a.unit_id, a.unit_name, date_format(b.date_created,\"%M %e, %Y %H:%i\"), "
			...
			while (oRset.next()) {
				...
				oRset1 = oStmt1.executeQuery(
						"select count(*)  from unit_student_association where unit_id = '" + oRset.getString(1) + "'");
	...
	public synchronized static Vector selectSynchronousEnvironmentForRegis() {
		...
		String strTime1 = calendarnow.get(Calendar.HOUR_OF_DAY) + ":" + calendarnow.get(Calendar.MINUTE) + ":"
				+ calendarnow.get(Calendar.SECOND);
		String strDate1 = calendarnow.get(Calendar.DATE) + "-" + (calendarnow.get(Calendar.MONTH) + 1) + "-"
	...
	/*-------------31122008------------------------*/
	public synchronized static void addRptdesign(String report_id, String report_file_size,
			String rptdesign_file_name) {
		...
		try {
			...
			PreparedStatement pstmt1 = oConn.prepareStatement(
					"update report_rptdetails set rptdesign_file_name=?, " + "report_file_size=? where report_id=?");
	 ...
	 * 
	 * // String str[]=new String[2]; Vector vSrcFile = new Vector(2,2);
	 * Statement oStmt=null; try { Connection oConn = ds1.getConnection(); oStmt
	 * = oConn.createStatement(); for(ResultSet oRset = oStmt.
	 * executeQuery("select a.rptdesign_file_name,a.report_file from report_rptdetails a where a.report_module='"
	 * +module+"'");oRset.next();) { Vector cols = new Vector();
	 * cols.addElement(oRset.getString(1));
	 * cols.addElement(oRset.getAsciiStream(2));
	 * //cols.addElement(oRset.getAsciiStream(3)); vSrcFile.addElement(cols);
	 * 
	 * } oStmt.close(); } catch (SQLException sqlexception) {
	 * System.out.println("Exception in BuildDatabaseLayer.getClassDetails()");
	 * System.out.println("The Error Message - " + sqlexception.getMessage()); }
	 * catch (Exception ex) {
	 * System.out.println("Exception in BuildDatabaseLayer.getClassDetails()");
	 * System.out.println("The Error Message - " + ex.getMessage()); }
	 * //connMgr.freeConnection("mysql", oConn); return vSrcFile; }
	 * 
	 * public static synchronized Vector getreportid(String module) {
	 * 
	 * Vector vector = new Vector(); try { Connection oConn =
	 * ds1.getConnection(); Statement statement = oConn.createStatement();
	 * //String as[]; for(ResultSet oRset = statement.
	 * executeQuery("select * from report_rptdetails where report_module='"
	 * +module+"'");oRset.next();) { String as[] = new String[7];
	 * as[0]=oRset.getString(1); // as.addElement(oRset.getString(2));
	 * as[1]=oRset.getString(2); as[2]=oRset.getString(3);
	 * as[3]=oRset.getString(4); as[4]=oRset.getString(5);
	 * as[5]=oRset.getString(6); as[6]=oRset.getString(7);
	 * 
	 * vector.addElement(as); }
	 * 
	 * statement.close(); } catch(SQLException sqlexception) {
	 ...
	 * System.out.println("Exception in ReportEngineDatabaseLayer.getreportid()"
	 * ); System.out.println("The Error Message - " + exception.getMessage()); }
	 * //connMgr.freeConnection("mysql", oConn); return vector; }
	 */

	public synchronized static void addSubEntryCatalog(String cat_id, String New_Entri_Name_text,
			String Entri_Name_text, String New_Entri_Desc_text) {
		Statement oStmt = null;
		Statement oStmt1 = null;
		...
		try {
			...
			if (cat_id != null) {
				...
				System.out.println(
						"-------------------insert into catalog_entry_details (cat_id,catalog_name,entry_name,parent_name,cat_description) values('"
								+ cat_id + "','" + cat_name + "','" + New_Entri_Name_text + "','" + Entri_Name_text
								+ "','" + New_Entri_Desc_text + "')");
				oStmt.execute(
						"insert into catalog_entry_details (cat_id,catalog_name,entry_name,parent_name,cat_description) values('"
								+ cat_id + "','" + cat_name + "','" + New_Entri_Name_text + "','" + Entri_Name_text
	...
	public synchronized static void addEntryCatalog(String cat_id, String Entri_Name_text, String parent_name,
			String Entri_Desc_text) {
		Statement oStmt = null;
		Statement oStmt1 = null;
		ResultSet oRset = null;
		Connection oConn = null;
		...
		try {
			...
			if (cat_id != null) {
				...
				System.out.println(
						"--------insert into catalog_entry_details (cat_id,catalog_name,entry_name,parent_name,cat_description) values('"
								+ cat_id + "','" + cat_name + "','" + Entri_Name_text + "','" + parent_name + "','"
								+ Entri_Desc_text + "')");
				oStmt.execute(
						"insert into catalog_entry_details (cat_id,catalog_name,entry_name,parent_name,cat_description) values('"
								+ cat_id + "','" + cat_name + "','" + Entri_Name_text + "','" + parent_name + "','"
	...
	public synchronized static void AssociateEntries(String cat_id, String Entri_Name_text, String course_id,
			String New_Entri_Desc_text, String user_id, String entryid) {
		Statement oStmt = null;
		String course_name = "";
		...
		try {
			...
			log.debug("-------11-----------select  course_name from course_definition  where  course_id='" + course_id
					+ "'");
			oRset2 = oStmt2
					.executeQuery("select  course_name from course_definition  where  course_id='" + course_id + "'");
			while (oRset2.next()) {
			...
			log.debug("--------33------select entryid from catalog_entry_details  where cat_id='" + cat_id
					+ "' and entry_name='" + Entri_Name_text + "'");
			oRset4 = oStmt4.executeQuery("select entryid from catalog_entry_details  where cat_id='" + cat_id
					+ "' and entry_name='" + Entri_Name_text + "'");
			if (oRset4.next()) {
			...
			log.debug(
					"------44-----insert into catalog_entry_entity(catalog_name,	entry_name,	entity_type,	entity_name,	entity_description,	created_by,created_on,entryid,cat_id) 		values ('"
							+ cat_name + "','" + Entri_Name_text + "','course','" + course_id + "','"
							+ New_Entri_Desc_text + "','" + user_id + "',sysdate(),'" + entryid + "','" + cat_id
							+ "')");
			oStmt.execute(
					"insert into catalog_entry_entity(catalog_name,entry_name,entity_type,entity_name,entity_description,created_by,created_on,entryid,cat_id) values ('"
							+ cat_name + "','" + Entri_Name_text + "','course','" + course_id + "','"
							+ New_Entri_Desc_text + "','" + user_id + "',sysdate(),'" + entryid + "','" + cat_id
							+ "')");
	...
	public synchronized static void addEntryCatalog(String Entri_id) {
		...
		try {
			...
			if (Entri_id != null) {
				...
				System.out.println(
						"--------select cat_id,entity_name from catalog_entry_entity where entryid='" + Entri_id + "'");
				oRset = oStmt1.executeQuery(
						"select cat_id,entity_name from catalog_entry_entity where entryid='" + Entri_id + "'");
				if (oRset.next()) {
				...
				if (course_id != null && cat_id != null) {
					...
					System.out.println("--------insert into catalog_temp (cat_id,entry_id,course_id) values('" + cat_id
							+ "','" + Entri_id + "','" + course_id + "')");
					oStmt.execute("insert into catalog_temp (cat_id,entry_id,course_id) values('" + cat_id + "','"
							+ Entri_id + "','" + course_id + "')");
					System.out.println(
							"--------************---------end------------**************------------------------------");
				}
	...
	public synchronized static void updateStudentDetails(String user_id, String FNamedata, String MNamedata,
			String LNamedata, String Agedata, String Experiencedata, String EduQuilidata, String Emaildata,
			String Genderdate, String QuestionPreferreddate, String MediaPreferreddata, String AccountStatusdata,
			String PermitSelfRegistrationdata) {
		...
		try {
			...
			oStmt = oConn.createStatement();
			oStmt2 = oConn.createStatement();
			System.out.println("------1111------------------update  student_details set sname ='" + LNamedata
					+ "',gender='" + Genderdate + "',age='" + Agedata + "', " + "edu_status='" + EduQuilidata
					+ "',experience = '" + Experiencedata + "',question_preffered= '" + QuestionPreferreddate + "', "
					+ "media_preffered= '" + MediaPreferreddata + "',email_id = '" + Emaildata + "'," + "first_name='"
					+ FNamedata + "',middle_name='" + MNamedata + "', account_status = '" + AccountStatusdata
					+ "', strself = '" + PermitSelfRegistrationdata + "' " + "where student_id='" + user_id + "'");

			oStmt.execute("update  student_details set sname ='" + LNamedata + "',gender='" + Genderdate + "',age='"
					+ Agedata + "', " + "edu_status='" + EduQuilidata + "',experience = '" + Experiencedata
					+ "',question_preffered= '" + QuestionPreferreddate + "', " + "media_preffered= '"
					+ MediaPreferreddata + "',email_id = '" + Emaildata + "'," + "first_name='" + FNamedata
					+ "',middle_name='" + MNamedata + "', account_status = '" + AccountStatusdata + "', strself = '"
					+ PermitSelfRegistrationdata + "' " + "where student_id='" + user_id + "'");

			System.out.println(
					"------2222-----------update student_creation_details set last_modification_date = sysdate() where student_id='"
							+ user_id + "'");
			oStmt2.execute("update student_creation_details set last_modification_date = sysdate() where student_id='"
					+ user_id + "'");
	...
	public synchronized static String[] getCourseInfo(String entry_id, String course_id, String user_id) {
		...
		try {
			...
			oStmt3 = oConn.createStatement();
			System.out.println(
					"-------------------SELECT d.catalog_name, c.entry_name, a.course_name, a.edate, a.description, a.confirmation_reqd "
							+ "FROM course_definition a,catalog_entry_entity b,catalog_entry_details c,catalog_details d "
							+ "where a.course_id=b.entity_name 	and b.entryid=c.entryid 	and c.cat_id=d.cat_id	and a.course_id='"
							+ course_id + "' and c.entryid='" + entry_id + "' ");
			...
			System.out.println("-------------SELECT *  FROM user_course_registration " + "where 	course_id='"
					+ course_id + "' and student_id='" + user_id + "' ");
			str[6] = "Not Registered";

			System.out.println("-------------------SELECT status  FROM confirmation_requisition " + "where 	id='"
					+ course_id + "' and user_id='" + user_id + "'  and entity_type='course'");
			oRset3 = oStmt3.executeQuery("SELECT status  FROM confirmation_requisition " + "where 	id='" + course_id
					+ "' and user_id='" + user_id + "'  and entity_type='course'");
			if (oRset3.next())
				str[6] = oRset3.getString(1);

			if (str[6].equals("Not Registered")) {
				oRset2 = oStmt2.executeQuery("SELECT *  FROM user_course_registration " + "where 	course_id='"
						+ course_id + "' and student_id='" + user_id + "' ");
	...
	public synchronized static String checkConfirmation(String strCourseId) {
		...
		try {
			...
			System.out.println(
					"------------------------select ifnull(confirmation_reqd,\"null\") from course_definition  where course_id = '"
							+ strCourseId + "'");
			oRset = oStmt.executeQuery(
					"select ifnull(confirmation_reqd,\"null\") from course_definition  where course_id = '"
							+ strCourseId + "'");
	...
	public synchronized static void sentForConfirmation(String user_id, String course_id) {
		...
		try {
			...
			oStmt.executeUpdate("insert into confirmation_requisition (id, user_id, " + "status,entity_type) values ('"
					+ course_id + "', '" + user_id + "','Pending','course')");
			// }
			// if ((strTotalTime.equals("")) && (!strValidTill.equals(""))) {
	...
	public synchronized static int insertCourseUserAssociationSelf(String user_id, String course_id) {
		...
		try {
			...
			oStmt2 = oConn.createStatement();
			oStmt3 = oConn.createStatement();
			System.out.println("-------------------------select * from user_course_registration where student_id = '"
					+ user_id + "' and course_id = '" + course_id + "'");
			oRset = oStmt.executeQuery("select * from user_course_registration where student_id = '" + user_id
					+ "' and course_id = '" + course_id + "'");
			if (oRset.next()) {

				// errorMessage(1063, out);
				// oStmt2.execute("delete from user_course_registration where
				// student_id = '"+user_id+"' and course_id = '"+course_id+"'");
				return count;
			} else {
				System.out.println(
						"------------insert into user_course_registration (student_id, course_id, modification_date) "
								+ "values ('" + user_id + "','" + course_id + "',sysdate())");
				count = oStmt3.executeUpdate(
						"insert into user_course_registration (student_id, course_id, modification_date) " + "values ('"
								+ user_id + "','" + course_id + "',sysdate())");
	...
	public static synchronized void ImportMatricef(String c_def[], String createdby) {
		...
		try {
			...
			// statement1.execute("insert into matricsmgmt(id, title,
			// description,textdata,numberdata,numberdata2,numberdata3,legenddata1,legenddata2,legenddata3,type,subtype,width,height,yaxis,xaxis,color,transpose,stacked,dimension)
			// values('"+c_def[0]+"','"+c_def[1]+"','"+c_def[2]+"','"+c_def[3]+"',sysdate(),'"+c_def[5]+"','"+c_def[6]+"','"+c_def[7]+"','"+c_def[8]+"','"+0+"','"+createdby+"')");
			statement1.execute(
					"insert into matricsmgmt(id,title,description,textdata,numberdata,numberdata2,numberdata3,legenddata1,legenddata2,legenddata3,type,subtype,width,height,xaxis,yaxis,color,transpose,stacked,dimension) values ('"
							+ c_def[0] + "','" + c_def[1] + "','" + c_def[2] + "','" + c_def[3] + "','" + c_def[4]
							+ "','" + c_def[5] + "','" + c_def[6] + "','" + c_def[7] + "','" + c_def[8] + "','"
							+ c_def[9] + "','" + c_def[10] + "','" + c_def[11] + "','" + c_def[12] + "','" + c_def[13]
							+ "','" + c_def[14] + "','" + c_def[15] + "','" + c_def[16] + "','" + c_def[17] + "','"
							+ c_def[18] + "','TwoDimensionalwithdepth')");
			// String c_id = returnmaxcourse();
			// statement1.execute("insert into collection_course
			// (course_id,collection_id) values('"+c_id+"','NULL')");
			// statement1.close();
			oConn.commit();
			oConn.setAutoCommit(true);
	...
	public synchronized static void deletetemp_catalogentry(String cat_id, String Entri_Name_text) {
		...
		try {
			...
			log.debug("--------33------select entryid from catalog_entry_details  where cat_id='" + cat_id
					+ "' and entry_name='" + Entri_Name_text + "'");
			oRset4 = oStmt.executeQuery("select entryid from catalog_entry_details  where cat_id='" + cat_id
					+ "' and entry_name='" + Entri_Name_text + "'");
			if (oRset4.next()) {
				entryid = oRset4.getString(1);
			}
	...
	public synchronized static void update_catalogentry(String entryid, String entryname, String entrydescription) {
		...
		try {
			...
			log.debug("------------update catalog_entry_details  set entry_name='" + entryname + "' , cat_description='"
					+ entrydescription + "'	where entryid='" + entryid + "' ");

			statement.execute("update catalog_entry_details  set entry_name='" + entryname + "' , cat_description='"
					+ entrydescription + "'	where entryid='" + entryid + "' ");
			statement.close();
	...
	public synchronized static Vector getDateTimeRequest(String course_id, String student_id) {
		...
		try {
			...
			System.out.println(
					"------------>select access_allowed_till,total_access_time from confirmation_requisition where id ='"
							+ course_id + "' and user_id='" + student_id + "' and entity_type='course'");
			oRset = oStmt.executeQuery(
					"select access_allowed_till,total_access_time from confirmation_requisition where id ='" + course_id
							+ "' and user_id='" + student_id + "' and entity_type='course'");
			if (oRset.next()) {
	...
	public synchronized static boolean insertCourseUserAssociation(String strUsrId, String strCourseId,
			String strCreatedBy, String strValidTill, String strTotalTime) {
		boolean flag = false;
		Statement oStmt = null;
		Statement oStmt1 = null;
		ResultSet oRset = null;
		...
		try {
			...
			System.out.println("------------------select * from user_course_registration where student_id = '"
					+ strUsrId + "' and course_id = '" + strCourseId + "'");
			oRset = oStmt.executeQuery("select * from user_course_registration where student_id = '" + strUsrId
					+ "' and course_id = '" + strCourseId + "'");
			if (oRset.next()) {
				System.out.println("----------------delete from user_course_registration where student_id = '"
						+ strUsrId + "' and course_id = '" + strCourseId + "'");
				oStmt1.execute("delete from user_course_registration where student_id = '" + strUsrId
						+ "' and course_id = '" + strCourseId + "'");
				// errorMessage(1063, out);
				// connMgr.freeConnection("mysql", oConn);
			...
			oStmt1.execute("insert into user_course_registration (student_id, course_id, registration_date, "
					+ "registration_by,modification_date) values ('" + strUsrId + "','" + strCourseId + "',sysdate(),'"
					+ strCreatedBy + "',sysdate())");

			if (strTotalTime.equals("") && strValidTill.equals("")) {
				System.out.println(
						"---------------insert into user_course_registration (student_id, course_id, registration_date, "
								+ "registration_by, access_allowed_till, total_access_time) values ('" + strUsrId
								+ "','" + strCourseId + "',sysdate(),'" + strCreatedBy + "',null,null)");

				flag = oStmt1
						.execute("insert into usergroup_course_registration (student_id, course_id, registration_date, "
								+ "registration_by, access_allowed_till, total_access_time) values ('" + strUsrId
								+ "','" + strCourseId + "',sysdate(),'" + strCreatedBy + "',null,null)");
			...
			if ((strTotalTime.equals("")) && (!strValidTill.equals(""))) {
				flag = oStmt1
						.execute("insert into usergroup_course_registration (student_id, course_id, registration_date, "
								+ "registration_by, access_allowed_till, total_access_time) values ('" + strUsrId
								+ "','" + strCourseId + "',sysdate(),'" + strCreatedBy + "','" + strValidTill
								+ "',null)");
			...
			if ((!strTotalTime.equals("")) && (strValidTill.equals(""))) {
				...
				flag = oStmt1
						.execute("insert into usergroup_course_registration (student_id, course_id, registration_date, "
								+ "registration_by, access_allowed_till, total_access_time) values ('" + strUsrId
								+ "','" + strCourseId + "',sysdate(),'" + strCreatedBy + "',null," + iTotalTime + ")");
	...
	public synchronized static boolean insertCourseUserAssociation2(String strUsrId, String strCourseId,
			String strCreatedBy, String strValidTill, String strTotalTime) {
		boolean flag = false;
		Statement oStmt = null;
		Statement oStmt1 = null;
		...
		try {
			...
			if (oRset.next()) {
				...
				// user_course_registration where student_id = '"+strUsrId+"'
				// and course_id = '"+strCourseId+"'");
				// oStmt1.execute("delete from user_course_registration where
				// student_id = '"+strUsrId+"' and course_id =
				// '"+strCourseId+"'");
				// errorMessage(1063, out);
				// connMgr.freeConnection("mysql", oConn);
			...
			if (strTotalTime.equals("") && strValidTill.equals("")) {
				System.out.println(
						"---------------insert into usergroup_course_registration (student_id, course_id, registration_date, "
								+ "registration_by, access_allowed_till, total_access_time) values ('" + strUsrId
								+ "','" + strCourseId + "',sysdate(),'" + strCreatedBy + "',null,null)");
			...
			log.debug("---------------update confirmation_requisition set status='Confirmed' where id ='" + strCourseId
					+ "' and user_id='" + strUsrId + "' and entity_type='course'");
			oStmt2.execute("update confirmation_requisition set status='Confirmed' where id ='" + strCourseId
					+ "' and user_id='" + strUsrId + "' and entity_type='course'");
	...
	public synchronized static boolean confirmedRequest(String strCourseId, String strUser_id, String e_type) {
		...
		try {
			oConn = ds1.getConnection();
			oStmt = oConn.createStatement();
			oStmt.execute("update confirmation_requisition set status='Confirmed' where id ='" + strCourseId
					+ "' and user_id='" + strUser_id + "' and entity_type='" + e_type + "'");
			log.debug("update confirmation_requisition set status='Confirmed' where id ='" + strCourseId
					+ "' and user_id='" + strUser_id + "' and entity_type='" + e_type + "'");
			flag = true;
		} catch (SQLException e) {
	...
	public synchronized static void CancelConfirmation(String user_id, String course_id) {
		...
		try {
			...
			System.out.println("------------------------delete from confirmation_requisition where id='" + course_id
					+ "' and  user_id ='" + user_id + "')");
			oStmt.execute("delete from confirmation_requisition where id='" + course_id + "' and  user_id ='" + user_id
	...
	public synchronized static void CancelSelfConfirmation(String strUsrId, String strCourseId) {
		...
		try {
			...
			oRset = oStmt.executeQuery("select * from user_course_registration where student_id = '" + strUsrId
					+ "' and course_id = '" + strCourseId + "'");
			while (oRset.next()) {
				System.out.println("---------------delete from user_course_registration where student_id = '" + strUsrId
						+ "' and course_id = '" + strCourseId + "'");
			...
			oStmt1.execute("delete from usergroup_course_registration where student_id = '" + strUsrId
					+ "' and course_id = '" + strCourseId + "'");
			System.out.println("---------------delete from confirmation_requisition where user_id = '" + strUsrId
					+ "' and id = '" + strCourseId + "' and entity_type='course' ");
			oStmt1.execute("delete from confirmation_requisition where user_id = '" + strUsrId + "' and id = '"
					+ strCourseId + "' and entity_type='course' ");
	...
	public synchronized static boolean denyRequest(String strCourseId, String strUser_id) {
		...
		try {
			Connection oConn = ds1.getConnection();
			oStmt = oConn.createStatement();
			System.out.println("--------------------update confirmation_requisition set status='Denied' where id ='"
					+ strCourseId + "' and user_id='" + strUser_id + "' and entity_type='course'");
			oStmt.execute("update confirmation_requisition set status='Denied' where id ='" + strCourseId
					+ "' and user_id='" + strUser_id + "' and entity_type='course'");
			oStmt.close();
			oConn.close();
			flag = true;
		} catch (SQLException e) {
	...
	// /*public synchronized static boolean CancelconfirmedRequest(String
	// strCourseId,String strUser_id,String e_type)
	// {
	//
	// boolean flag = false;
	// Statement oStmt=null;
	...
	// oConn = ds1.getConnection();
	// oStmt = oConn.createStatement();
	// oStmt.execute("update confirmation_requisition set status='Pending' where
	// id ='"+strCourseId+"' and user_id='"+strUser_id+"' and
	// entity_type='"+e_type+"'");
	//
	// flag = true;
	// }
	...
	public synchronized static Vector getCourseGroupAssociation1(String strUnitId) {
		...
		try {
			...
			oStmt = oConn.createStatement();
			oRset = oStmt
					.executeQuery("select count(*)  from unit_group_association where unit_id='" + strUnitId + "'");
			int l_i = 0;
			while (oRset.next()) {
				l_i = oRset.getInt(1);
			}
			...
			oStmt = oConn.createStatement();
			oRset = oStmt.executeQuery(
					"select a.group_id, b.group_name, date_format(a.date_registration,\"%M %e, %Y %H:%i\"), " +
					// "concat(c.user_first_name,' ', c.user_middle_name,'
					// ',c.user_last_name), "+
							"date_format(a.access_allowed_till,\"%M %e, %Y\"), "
							+ "date_format(a.access_allowed_till,\"%d/%m/%Y\"), " + "a.total_access_time "
	...
	public synchronized static Vector getCourseUserAssociation1(String strUnitId) {
		...
		try {
			...
			oStmt = oConn.createStatement();
			oRset = oStmt
					.executeQuery("select count(*)  from unit_student_association where unit_id='" + strUnitId + "'");
			int l_i = 0;
			while (oRset.next()) {
				l_i = oRset.getInt(1);
			}
			...
			oStmt = oConn.createStatement();
			oRset = oStmt.executeQuery(
					"select a.student_id, concat(b.first_name,' ',b.middle_name,' ',b.sname), date_format(a.date_registration,\"%M %e, %Y %H:%i\"), "
							+
							// "concat(c.user_first_name,' ',
							// c.user_middle_name,' ',c.user_last_name), "+
							"date_format(a.access_allowed_till,\"%M %e, %Y\"), "
							+ "date_format(a.access_allowed_till,\"%d/%m/%Y\"), " + "a.total_access_time "
			...
			while (oRset.next()) {
				...
				ResultSet oRset1 = oStmt1.executeQuery(
						"select a.group_name from student_group a, student_group_association b where b.student_id='"
								+ oRset.getString(1) + "' " + "and b.group_id = a.group_id");
				while (oRset1.next()) {
	...
	public static synchronized void createTableScormInitialization(String unit_id, String user_id) {
		...
		try {
			...
			oRset2 = oStmt2.executeQuery(
					"select a.sco_id, b.title, a.lessonstatus, a.lessonmode, a.entry1, a.exit1, a.totaltime from userscoinfo a, iteminfo b where a.user_id = '"
							+ user_id + "' and a.unit_id='" + unit_id
							+ "' and a.sco_id=b.identifier and a.unit_id=b.unit_id");
			while (oRset2.next()) {
				...
				statement = oConn.createStatement();
				System.out.println(
						"insert into temp_scorm_initialization(scoid,title,lessonstatus,lessonmode,exit1,entry1,totaltime) values ('"
								+ SCOID + "','" + Title + "','" + LessonStatus + "','" + LessonMode + "','" + Entry
								+ "','" + Exit + "','" + TotalTime + "')");
				boolean flag = statement.execute(
						"insert into temp_scorm_initialization(scoid,title,lessonstatus,lessonmode,exit1,entry1,totaltime)"
								+ " values ('" + SCOID + "','" + Title + "','" + LessonStatus + "','" + LessonMode
								+ "','" + Entry + "','" + Exit + "','" + TotalTime + "')");
	...
	public synchronized static void SCOInitialize2(String strUsrId, String strUnitId, String strsco, String strMode,
			String strEntry, String strSuspend, String strStatus, String strCredit, String strExit, String strLaunch,
			String strTime) {
		...
		try {
			oConn = ds1.getConnection();
			oStmt = oConn.createStatement();
			System.out.println("update userscoinfo set lessonmode='" + strMode + "', entry1='" + strEntry
					+ "', credit='" + strCredit + "', lessonstatus='" + strStatus + "', launch='" + strLaunch
					+ "', exit1='" + strExit + "', totaltime='" + strTime + "' where user_id='" + strUsrId
					+ "' and unit_id='" + strUnitId + "' and sco_id='" + strsco + "'");
			oStmt.execute("update userscoinfo set lessonmode='" + strMode + "', entry1='" + strEntry + "', credit='"
					+ strCredit + "', lessonstatus='" + strStatus + "', launch='" + strLaunch + "', exit1='" + strExit
					+ "', totaltime='" + strTime + "' where user_id='" + strUsrId + "' and unit_id='" + strUnitId
					+ "' and sco_id='" + strsco + "'");
	...
	public synchronized static Vector getUserGroupDetailsList(String strGrId) {
		...
		try {
			...
			oStmt = oConn.createStatement();
			oRset = oStmt
					.executeQuery("select count(*) from student_group_association where group_id = '" + strGrId + "'");
			int l_i = 0;
			while (oRset.next()) {
				l_i = oRset.getInt(1);
			}
			...
			oRset = oStmt.executeQuery("select a.student_id, concat(b.first_name,' ', b.middle_name,' ',b.sname) "
					+ "from student_group_association a, student_details b where a.group_id = '" + strGrId
					+ "' and a.student_id=b.student_id");
			while (oRset.next()) {
				Vector vGroup = new Vector();
				vGroup.addElement(oRset.getString(1));
	...
	public synchronized static void SCOInitialize(String strUsrId, String strUnitId, String strMode, String strEntry,
			String strSuspend, String strStatus, String strCredit, String strExit, String strLaunch, String strTime) {
		...
		try {
			oConn = ds1.getConnection();
			oStmt = oConn.createStatement();
			System.out.println("update userscoinfo set lessonmode='" + strMode + "',entry1='" + strEntry + "', credit='"
					+ strCredit + "', lessonstatus='" + strStatus + "', launch='" + strLaunch + "', exit1='" + strExit
					+ "', totaltime='" + strTime + "' where user_id='" + strUsrId + "' and unit_id='" + strUnitId
					+ "'");
			oStmt.execute("update userscoinfo set lessonmode='" + strMode + "',entry1='" + strEntry + "', credit='"
	...
	public synchronized static Vector getUserDetails() {
		...
		try {
			...
			oStmt = oConn.createStatement();
			oStmt1 = oConn.createStatement();
			// oRset=oStmt.executeQuery("select
			// a.student_id,b.password,a.first_name,a.middle_name,a.sname,"+
			// "
			// a.gender,a.account_status,c.role_id,d.date_student_created,d.student_created_by,d.last_modification_date
			// from student_details a,"+
			// " student_password b,user_role c,student_creation_details d"+
			// " where a.student_id=b.student_id and a.student_id=c.user_id and
	...
	public synchronized static Vector<Vector<String>> getGroupDetails() {
		...
		try {
			...
			oStmt = oConn.createStatement();
			oRset = oStmt.executeQuery(
					"select a.group_id,a.group_name,a.group_created_date,a.group_created_by" + " from student_group a");
	...
	public synchronized static Vector<String> getGroupUserRegDetails(String groupid) {
		...
		try {
			...
			oStmt = oConn.createStatement();
			oRset = oStmt
					.executeQuery("select student_id from student_group_association where group_id='" + groupid + "'");
	...
	public synchronized static Vector getUnitUserRegistration(String unitid) {
		...
		try {
			...
			oStmt = oConn.createStatement();
			oRset = oStmt.executeQuery(
					"select student_id,access_allowed_till,total_access_time from unit_student_association"
	...
	@Deprecated
	public static Vector<Vector<String>> getUnitInfo() {
		...
		try {
			...
			rs = stmt.executeQuery(
					"select a.course_id, a.course_name,b.status, b.controll, b.created_by, b.date_created, b.modified_by, b.date_modified, b.self_regis, b.confirmation_reqd, b.confirmed_by"
							+ " from course a,course_creation_details b" + " where a.course_id = b.course_id");
			while (rs.next()) {
				Vector<String> v1 = new Vector<String>();
			...
			if (stmt != null) {
				try {
					...
					log.debug("Cannot close Statement" + e);
				}
				stmt = null;
			}
			if (conn != null) {
				try {
					...
					log.debug("Cannot close Connection" + ce);
				}
			}
		}
		return unitDetails;
	 ...
	 *             {@link #getUnitGroupRegistration(String)}
	 */

	@Deprecated
	public static Vector<Vector<String>> getUnitGroupAssnInfo(String unitid) {
	...
	/**
	 * @deprecated As of release 7.0, replaced by
	 *             {@link #getUnitUserRegistration(String)}
	 */

	@Deprecated
	public static Vector<Vector<String>> getUnitUserRegnInfo(String unitid) {
		...
		try {
			...
			stmt = conn.createStatement();
			rs = stmt.executeQuery(
					"select student_id,access_allowed_till,total_access_time from course_student_association"
	...
	public static Vector getForumInfo() {
		...
		try {
			...
			stmt = conn.createStatement();
			rs = stmt.executeQuery(
					"select forum_id, forum_name, no_of_thread, no_of_message, last_message_posted, start_date, strself, confirm_by, confirmation_reqd, created_by from "
							+ " forum");
			while (rs.next()) {
	...
	public static Vector<String[]> getCourseInfo() {
		...
		try {
			...
			stmt = conn.createStatement();
			rs = stmt.executeQuery(
					"select course_id, course_name, type, session, sdate, edate, createdby, createdon, description, cpoints, ttimes, cost, intructor, intructor1, file_name, file_name1 from "
							+ " course_definition");
			while (rs.next()) {
	...
	public static Vector getForumRegnInfo(String forumid) {
		...
		try {
			conn = ds1.getConnection();
			stmt = conn.createStatement();
			// System.out.println("select user_id, registered_by, no_of_posts,
			// no_of_views, last_posted_on, last_viewed_on"+
			// " from forum_registration_report where forum_id =
			// '"+forumid+"'");
			rs = stmt.executeQuery(
					"select user_id, registered_by, no_of_posts, no_of_views, last_posted_on, last_viewed_on"
	...
	// System.out.println("SQLException in DatabaseLayer.getForumRegnInfo()");
	// System.out.println("The Error Message - " + sqlexception.getMessage());
	// log.debug("SQLException in DatabaseLayer.getForumRegnInfo()"+
	// sqlexception);
	// } catch (Exception ex) {
	// System.out.println("Exception in DatabaseLayer.getForumRegnInfo()");
	// System.out.println("The Error Message - " + ex.getMessage());
	...
	// } finally {
	// if (rs != null) {
	// try { rs.close(); } catch (SQLException e) { log.debug("Cannot close
	// ResultSet"+ e); }
	// rs = null;
	// }
	// if (stmt != null) {
	// try { stmt.close(); } catch (SQLException e) { log.debug("Cannot close
	// Statement"+ e); }
	// stmt = null;
	// }
	// if(conn != null) {
	...
	public static Vector<Vector<String>> getCourseRegnInfo() {
		...
		try {
			conn = ds1.getConnection();
			stmt = conn.createStatement();
			rs = stmt.executeQuery("select distinct course_id" + " from user_course_registration");
			while (rs.next()) {
			...
			rs = stmt.executeQuery("select distinct course_id" + " from group_course_registration");
			while (rs.next()) {
	...
	public static Vector<String[]> getCourseUserRegnInfo(String courseid) {
		...
		try {
			conn = ds1.getConnection();
			stmt = conn.createStatement();
			// System.out.println("select student_id, registration_by,
			// registration_date, modification_date"+
			// " from user_course_registration where course_id =
			// '"+courseid+"'");
	...
	public static Vector<String[]> getCourseGroupRegnInfo(String courseid) {
		...
		try {
			conn = ds1.getConnection();
			stmt = conn.createStatement();
			// System.out.println("select group_id, registration_by,
			// registration_date, access_allowed_till, total_access_time,
			// modification_date"+
			// " from group_course_registration where course_id =
			// '"+courseid+"'");
			rs = stmt.executeQuery(
					"select group_id, registration_by, registration_date, access_allowed_till, total_access_time, modification_date"
	...
	/**
	 * @deprecated As of release 7.0, replaced by
	 *             {@link importData(ArrayList<String[]>, ArrayList<String[]>,
	 *             Hashtable<String, ArrayList>, ArrayList<String[]>,
	 *             Hashtable<String, ArrayList>, ArrayList<String[]>,
	 *             Hashtable<String, ArrayList>, Hashtable<String, ArrayList>)}
	 */

	@Deprecated
	protected static boolean importSystemData(ArrayList<String[]> arUser, ArrayList<String[]> arGroup,
			Hashtable<String, ArrayList> htUserGroup, ArrayList<String[]> arUnit,
			Hashtable<String, ArrayList> htUnitUser, ArrayList<String[]> arCourse,
			Hashtable<String, ArrayList> htCourseUser, Hashtable<String, ArrayList> htCourseGroup) {
		...
		try {
			...
			for (String[] strGroup : arGroup) {
				if (strGroup[0] != null && !strGroup[0].equals("")) {
					...
					// System.out.println("======Old Group ID: " +strGroup[0]+ "
					// New Group ID: "+maxgroupid);
			...
			for (String[] strUnit : arUnit) {
				if (strUnit[0] != null && !strUnit[0].equals("")) {
					...
					// System.out.println("======Old Unit ID: " +strUnit[0]+ "
					// New Unit ID: "+maxunitid);
			...
			while (itrUU.hasNext()) {
				...
				if (newunitid != null) {
					for (String[] strUser : (ArrayList<String[]>) htUnitUser.get(unitid)) {
						if (strUser[0] != null && !strUser[0].equals("")) {
							if (!exists("course_student_association", "course_id", "student_id", newunitid,
									strUser[0])) {
								pstmt.setInt(1, newunitid);
								pstmt.setString(2, strUser[0]);
			...
			for (String[] strCourse : arCourse) {
				if (strCourse[0] != null && !strCourse[0].equals("")) {
					...
					// System.out.println("======Old Course ID: " +strCourse[0]+
					// " New Course ID: "+maxcourseid);
			...
			while (itrCU.hasNext()) {
				...
				if (newcourseid != null) {
					for (String[] strUser : (ArrayList<String[]>) htCourseUser.get(courseid)) {
						if (strUser[0] != null && !strUser[0].equals("")) {
							if (!exists("user_course_registration", "course_id", "student_id", newcourseid,
									strUser[0])) {
			...
			while (itrCG.hasNext()) {
				...
				if (newcourseid != null) {
					for (String[] strGroup : (ArrayList<String[]>) htCourseGroup.get(courseid)) {
						if (strGroup[0] != null && !strGroup[0].equals("")) {
							if (!exists("group_course_registration", "course_id", "group_id", newcourseid,
									strGroup[0])) {
								pstmt.setInt(1, newcourseid);
	...
	protected static boolean importData(ArrayList<String[]> arUser, ArrayList<String[]> arGroup,
			Hashtable<String, ArrayList> htUserGroup, ArrayList<String[]> arUnit,
			Hashtable<String, ArrayList> htUnitUser, ArrayList<String[]> arCourse,
			Hashtable<String, ArrayList> htCourseUser, Hashtable<String, ArrayList> htCourseGroup,
			ArrayList<String[]> aForum, ArrayList<String[]> aForumThread, ArrayList<String[]> aForumUReg,
			ArrayList<String[]> aForumGrReg, ArrayList<String[]> aNotice) {
		...
		try {
			...
			for (String[] strUser : arUser) {
				...
				if (strUser[5] != null && !strUser[5].equals("") && !strUser[5].equals("role is not defined yet")
						&& strUser[2] != null && !strUser[2].equals("")) {
					if (!exists("user_role", "user_id", strUser[2])) {
						pstmt.setString(1, strUser[2]);
						pstmt.setString(2, strUser[5]);
						pstmt.executeUpdate();
			...
			pstmt = conn.prepareStatement(
					"insert into forum (forum_id, forum_name, no_of_thread, no_of_message,  created_by,start_date,strself,confirm_by,confirmation_reqd) values(?,?,?,?,?,?,?,?,?)");
			...
			pstmt = conn.prepareStatement(
					"insert into forum_thread (forum_id, forum_name, thread_id, thread_title, no_of_message, created_by,created_on,no_of_views,parent_thread) values(?,?,?,?,?,?,?,?,?)");
			...
			pstmt = conn.prepareStatement(
					"insert into forum_message_body (forum_id, forum_name, message_id, thread_title, message, created_by,created_on,attachments) values(?,?,?,?,?,?,?,?)");
			for (String[] strForumThread : aForumThread) {
				if (strForumThread[0] != null && !strForumThread[0].equals("")) {
					pstmt.setString(1, strForumThread[0]);
					pstmt.setString(2, strForumThread[1]);
			...
			pstmt = conn.prepareStatement(
					"insert into user_forum_association (forum_id, student_id,registered_by) values(?,?,?)");
			...
			pstmt = conn.prepareStatement(
					"insert into group_forum_association (forum_id, group_id,registered_by) values(?,?,?)");
			for (String[] strForumGrReg : aForumGrReg) {
				if (strForumGrReg[0] != null && !strForumGrReg[0].equals("")) {
					if (!exists("group_forum_association", "forum_id", "group_id", strForumGrReg[0],
							strForumGrReg[1])) {
			...
			pstmt = conn.prepareStatement(
					"insert into bulletin_board (notice_id,heading,student_id,posted_on,group_id,status,body,attachments) values(?,?,?,?,?,?,?,?)");
	...
	public static boolean exists(int groupid, String userid) {
		...
		try {
			conn = ds1.getConnection();
			stmt = conn.createStatement();
			rs = stmt.executeQuery("select * from student_group_association where group_id = " + groupid
	...
	public static boolean exists(String tablename, String field1, String field2, String field1value,
			String field2value) {
		...
		try {
			conn = ds1.getConnection();
			stmt = conn.createStatement();
			rs = stmt.executeQuery("select * from " + tablename + " where " + field1 + " = '" + field1value + "' and  "
					+ field2 + " = '" + field2value + "'");
			while (rs.next()) {
				...
				if (strUser[2] != null && !strUser[2].equals("")) {
					...
					if (strUser[11].equals("yes")) {
						...
						PreparedStatement pstmt = oConn
								.prepareStatement("update student_details SET photo= ? where student_id=?");
	...
	public static Vector<String[]> getForumInformation() {
		...
		try {
			...
			stmt = conn.createStatement();
			rs = stmt.executeQuery(
					"select a.forum_id, a.forum_name, a.no_of_message,count(b.thread_id),a.last_message_posted,a.created_by,a.start_date,a.strself,a.confirm_by,a.confirmation_reqd"
	...
	public static Vector<String[]> getForumsThread(String forumid) {
		...
		try {
			...
			rs = stmt.executeQuery("select thread_id, thread_title" + " from forum_thread" + " where forum_id='"
					+ forumid + "' and parent_thread='0'");
			while (rs.next()) {
				...
				// System.out.println("parent_thread===1===:"+parent_thread+"
				// noofmessage=="+noofmessage);
				do {
					rs1 = stmt1.executeQuery("select thread_id,created_on,created_by from forum_thread where forum_id='"
							+ forumid + "' and parent_thread='" + parent_thread + "'");
					...
					// System.out.println("parent_thread===2===:"+parent_thread+"
					// noofmessage=="+noofmessage);
	...
	public static Vector<String[]> getForumsMessage(String forumid, String threadid) {
		...
		try {
			...
			do {
				...
				rs = stmt.executeQuery(
						"select a.created_by, a.created_on, a.message, a.attachments,a.thread_title, b.no_of_views"
								+ " from forum_message_body a,forum_thread b "
								+ " where a.forum_id=b.forum_id and a.message_id=b.thread_id and a.forum_id='" + forumid
								+ "' and a.message_id='" + threadid + "'");
				while (rs.next()) {
				...
				rs1 = stmt1.executeQuery("select thread_id from forum_thread where forum_id='" + forumid
						+ "' and parent_thread='" + threadid + "'");
	...
	public static Vector<String[]> getForumUserRegnInfo(String forumid) {
		...
		try {
			conn = ds1.getConnection();
			stmt = conn.createStatement();
			rs = stmt.executeQuery("select student_id, registered_by" + " from user_forum_association where forum_id='"
					+ forumid + "'");
			while (rs.next()) {
				String[] str = new String[2];
				str[0] = rs.getString(1);
	...
	public static Vector<String[]> getForumGroupRegnInfo(String forumid) {
		...
		try {
			conn = ds1.getConnection();
			stmt = conn.createStatement();
			rs = stmt.executeQuery("select group_id, registered_by" + " from group_forum_association where forum_id='"
					+ forumid + "'");
			while (rs.next()) {
				String[] str = new String[2];
				str[0] = rs.getString(1);
	...
	public static Vector<String[]> getNoticeInformation() {
		...
		try {
			...
			stmt = conn.createStatement();
			rs = stmt.executeQuery(
					"select notice_id,heading,body,student_id,posted_on,attachments,status,group_id from bulletin_board");
			while (rs.next()) {
	...
	public static String getSelfRegsStatus(String strUserID) {
		...
		try {
			...
			rs = stmt.executeQuery(
					"select student_id,strself from student_details where student_id='" + strUserID + "'");
			while (rs.next()) {
	...
	public static String getCourseSelfRegsStatus(String strCourse) {
		...
		try {
			...
			rs = stmt.executeQuery(
					"select course_id,self_regis from course_definition where course_id='" + strCourse + "'");
			while (rs.next()) {
	...
	public synchronized static Vector getDateTimeRequestForUnit(String unit_id, String student_id) {
		...
		try {
			...
			System.out.println(
					"------------select access_allowed_till,total_access_time from confirmation_requisition where id ='"
							+ unit_id + "' and user_id='" + student_id + "' and entity_type='unit'");
			oRset = oStmt.executeQuery(
					"select access_allowed_till,total_access_time from confirmation_requisition where id ='" + unit_id
							+ "' and user_id='" + student_id + "' and entity_type='unit'");
			if (oRset.next()) {
				vDateTime.addElement(oRset.getString(1));
				vDateTime.addElement(oRset.getString(2));
			}
	...
	public synchronized static String insertUnitUserAssociation(String strUsrId, String unit_id, String strCreatedBy,
			String strValidTill, String strTotalTime) {
		String msg = "";
		Statement oStmt = null;
		Statement oStmt1 = null;
		ResultSet oRset = null;
		...
		try {
			...
			System.out.println("------------------select * from unit_student_association where student_id = '"
					+ strUsrId + "' and unit_id = '" + unit_id + "'");
			oRset = oStmt.executeQuery("select * from unit_student_association where student_id = '" + strUsrId
					+ "' and unit_id = '" + unit_id + "'");
			if (oRset.next()) {
				...
				if (strTotalTime.equals("") && strValidTill.equals("")) {
					...
					oStmt1.executeUpdate("insert into unit_student_association (student_id, unit_id,date_registration, "
							+ "registered_by, access_allowed_till, total_access_time) values ('" + strUsrId + "','"
							+ unit_id + "',sysdate(),'" + strCreatedBy + "',null,null)");

					msg = "Successfully Registered";

				}
				if ((strTotalTime.equals("")) && (!strValidTill.equals(""))) {
					oStmt1.executeUpdate(
							"insert into unit_student_association (student_id, unit_id, date_registration, "
									+ "registered_by, access_allowed_till, total_access_time) values ('" + strUsrId
									+ "','" + unit_id + "',sysdate(),'" + strCreatedBy + "','" + strValidTill
									+ "',null)");
				...
				if ((!strTotalTime.equals("")) && (strValidTill.equals(""))) {
					...
					oStmt1.executeUpdate(
							"insert into unit_student_association (student_id, unit_id, date_registration, "
									+ "registered_by, access_allowed_till, total_access_time) values ('" + strUsrId
									+ "','" + unit_id + "',sysdate(),'" + strCreatedBy + "',null," + iTotalTime + ")");
	...
	public synchronized static String denyUnitRequest(String unit_id, String strUser_id) {
		...
		try {
			...
			oStmt = oConn.createStatement();
			System.out.println("--------------------update confirmation_requisition set status='Denied' where id ='"
					+ unit_id + "' and user_id='" + strUser_id + "' and entity_type='unit'");
			oStmt.execute("update confirmation_requisition set status='Denied' where id ='" + unit_id
					+ "' and user_id='" + strUser_id + "' and entity_type='unit'");
	...
	public synchronized static void deleteUnitUserAssociation(String strUsrId, String unit_id) {
		...
		try {
			...
			oRset = oStmt.executeQuery("select * from unit_student_association where student_id = '" + strUsrId
					+ "' and unit_id = '" + unit_id + "'");
			if (oRset.next()) {
				oStmt1.executeUpdate("delete from unit_student_association where student_id='" + strUsrId
						+ "' and unit_id='" + unit_id + "'");
			}
	...
	public synchronized static void deleteCourseUserAssociation(String strUsrId, String course_id) {
		...
		try {
			...
			System.out.println("------------------select * from usergroup_course_registration where student_id = '"
					+ strUsrId + "' and course_id = '" + course_id + "'");
			oRset = oStmt.executeQuery("select * from usergroup_course_registration where student_id = '" + strUsrId
					+ "' and course_id = '" + course_id + "'");
			if (oRset.next()) {
				oStmt1.executeUpdate("delete from usergroup_course_registration where student_id='" + strUsrId
						+ "' and course_id='" + course_id + "'");
				oStmt1.executeUpdate("delete from user_course_registration where student_id='" + strUsrId
						+ "' and course_id='" + course_id + "'");
			}
	...
	public synchronized static String getCourseSelfConfirmationStatus(String course_id, String student_id) {
		...
		try {
			...
			oRset = oStmt.executeQuery("select status from confirmation_requisition where id ='" + course_id
					+ "' and user_id='" + student_id + "' and entity_type='course'");
			if (oRset.next()) {
		...
		try {
			...
			if (rs.next()) {
				...
				//
					...
					/*
					 * FileImageInputStream input = new FileImageInputStream(new
					 * File(dirName+"male.gif")); output = new
					 * ByteArrayOutputStream(); buf = new byte[512];
					 * 
					 * int numBytesRead = 0; while ((numBytesRead =
					 * input.read(buf)) != -1) { output.write(buf, 0,
					 * numBytesRead); }
					 * 
					 * _blob = output.toByteArray(); output.close();
					 * input.close(); System.out.println("from images");
					 */
				}
	...
	public synchronized static Vector getStudentDetails(String student_id) {
		...
		try {
			...
			oStmt = oConn.createStatement();
			oRset = oStmt.executeQuery(
					"select student_id,concat(first_name,' ',middle_name,' ',sname),gender,age,experience,edu_status,account_status,department,email_id,strself from student_details where student_id='"
							+ student_id + "'");
			System.out.println(
					"select student_id,concat(first_name,' ',middle_name,' ',sname),gender,age,experience,edu_status,account_status,department,email_id,strself from student_details where student_id='"
							+ student_id + "'");
	...
	public static synchronized String updateStudentEmailId(String studentId, String dept_id) {
		...
		try {
			...
			// System.out.println("update student_details set
			// email_id='"+email+"' where student_id='"+studentId+"'");
	...
	public static synchronized void updateallStudentSerialNo() {
		...
		try {
			...
			while (oRset1.next()) {
				...
				slno = slno + 1;
				// System.out.println("update student_details set
				// serial_no='"+slno+"' where student_id='"+student_id+"'");
				oStmt.execute(
						"update student_details set serial_no='" + slno + "' where student_id='" + student_id + "'");
			}
		} catch (SQLException sqlexception) {
	...
	public synchronized static Vector getDateTimeRequestForForum(String forum_id, String student_id) {
		...
		try {
			...
			System.out.println(
					"------------select access_allowed_till,total_access_time from confirmation_requisition where id ='"
							+ forum_id + "' and user_id='" + student_id + "' and entity_type='forum'");
			oRset = oStmt.executeQuery(
					"select access_allowed_till,total_access_time from confirmation_requisition where id ='" + forum_id
							+ "' and user_id='" + student_id + "' and entity_type='forum'");
			if (oRset.next()) {
				vDateTime.addElement(oRset.getString(1));
				vDateTime.addElement(oRset.getString(2));
			}
	...
	public synchronized static String insertForumUserAssociation(String strUsrId, String forum_id, String strCreatedBy,
			String strValidTill, String strTotalTime) {
		String msg = "";
		Statement oStmt = null;
		Statement oStmt1 = null;
		...
		try {
			...
			System.out.println("------------------select * from user_forum_association where student_id = '" + strUsrId
			...
			if (oRset.next()) {
				...
				if (strTotalTime.equals("") && strValidTill.equals("")) {
					oStmt1.executeUpdate(
							"insert into user_forum_association (student_id, forum_id,registered_by, access_allowed_till, total_access_time) values ('"
									+ strUsrId + "','" + forum_id + "','" + strCreatedBy + "',null,null)");
	...
	public synchronized static void deleteForumUserAssociation(String strUsrId, String forum_id) {
		...
		try {
			...
			oRset = oStmt.executeQuery("select * from user_forum_association where student_id = '" + strUsrId
					+ "' and forum_id = '" + forum_id + "'");
			if (oRset.next()) {
				oStmt1.executeUpdate("delete from user_forum_association where student_id='" + strUsrId
						+ "' and forum_id='" + forum_id + "'");
			}
	...
	public synchronized static String denyForumRequest(String forum_id, String strUser_id) {
		...
		try {
			...
			oStmt = oConn.createStatement();
			System.out.println("--------------------update confirmation_requisition set status='Denied' where id ='"
					+ forum_id + "' and user_id='" + strUser_id + "' and entity_type='forum'");
			oStmt.execute("update confirmation_requisition set status='Denied' where id ='" + forum_id
					+ "' and user_id='" + strUser_id + "' and entity_type='forum'");
	...
	public synchronized static boolean saveHomePageContent(String unitId, String homePageContent) {
		Statement oStmt = null;
		...
		try {
			...
			/*
			 * oStmt.
			 * executeUpdate("delete from home_page_management where unit_id='"
			 * + unitId + "'");
			 * 
			 ...
			 * 
			 */
			String queryString = "INSERT INTO home_page_management (unit_id, home_title) VALUES('" + unitId + "','"
					+ homePageContent + "') " + "ON DUPLICATE KEY UPDATE home_title=VALUES(home_title)";
	...
	public synchronized static String fetchHomePageContent(String unitId) {
		...
		try {
			...
			oRset = oStmt
					.executeQuery("select h.home_title from home_page_management h where h.unit_id = '" + unitId + "'");
	...
	/* Anupam Samanta */
	public synchronized static String getEmail(String student_id) {
		...
		try {
			...
			String sql = "select email_id from student_details where student_id='" + student_id + "'";
			oRset = oStmt.executeQuery(sql);
			if (oRset.next()) {
				mbox = oRset.getString(1);
	...
	public synchronized static String updateEventDetails(String user_id, String start, String end, String event) {
		String a = "";
		...
		try {
			...
			String sql = "select event from event_detail where student_id='" + user_id + "'";
			oRset = oStmt.executeQuery(sql);
			if (oRset.next()) {
				mbox = oRset.getString(1);
